...
- vaadin-spring-crud-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadin-spring-crud-ui: main application module, development time
- vaadin-spring-crud-production: module that produces a production mode WAR for deployment
